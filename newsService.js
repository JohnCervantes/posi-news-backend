export async function fetchNews({ q = 'positive OR positivity OR uplifting OR inspiring OR inspiration OR "feel good" OR "good news" OR Heartwarming OR "Acts of kindness" OR Hopeful', language = 'en', page = 1, pageSize = 20 } = {}) {
